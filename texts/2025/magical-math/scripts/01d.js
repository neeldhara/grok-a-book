document.addEventListener('DOMContentLoaded', function() {
    // Elements
    const playerCardsContainer = document.getElementById('player-cards-e');
    const targetCardsContainer = document.getElementById('target-cards-e');
    const cutFlipBtn = document.getElementById('cut-flip-btn-e');
    const resetBtn = document.getElementById('reset-btn-e');
    const impossibleBtn = document.getElementById('impossible-btn-e');
    const cutSlider = document.getElementById('cut-slider-e');
    const sliderValue = document.getElementById('slider-value-e');
    const movesCounter = document.getElementById('moves-counter-e');
    const resultMessage = document.getElementById('result-message-e');
