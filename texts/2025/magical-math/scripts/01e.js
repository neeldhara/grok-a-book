document.addEventListener('DOMContentLoaded', function() {
    // Elements
    const playerCardsContainer = document.getElementById('player-cards-m');
    const targetCardsContainer = document.getElementById('target-cards-m');
    const cutFlipBtn = document.getElementById('cut-flip-btn-m');
    const resetBtn = document.getElementById('reset-btn-m');
    const impossibleBtn = document.getElementById('impossible-btn-m');
    const cutSlider = document.getElementById('cut-slider-m');
    const sliderValue = document.getElementById('slider-value-m');
    const movesCounter = document.getElementById('moves-counter-m');
    const resultMessage = document.getElementById('result-message-m');
